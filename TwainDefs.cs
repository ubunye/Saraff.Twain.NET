...
namespace Saraff.Twain
{
    ...
    internal enum TwDAT : ushort
    {
        ...
        IccProfile =
            0x0401, /* TW_MEMORY        Added 1.91  This Data Argument is misplaced but belongs to the DG_IMAGE Data Group */

        ImageMemFileXfer =
            0x0402, /* TW_IMAGEMEMXFER  Added 1.91  This Data Argument is misplaced but belongs to the DG_IMAGE Data Group */

        EntryPoint =
            0x0403, /* TW_ENTRYPOINT    Added 2.0   This Data Argument is misplaced but belongs to the DG_CONTROL Data Group */
    ...
    public enum TwRC : ushort
    {
        ...
        ///     The requested TWEI_ data is either not supported by this data source, or is not supported for this particular
        ///     image.
        /// </summary>
    ...
    {
        private static readonly Dictionary<TwType, Type> _typeof = new Dictionary<TwType, Type>
        {
        ...
        private static readonly Dictionary<int, TwType> _typeofAux = new Dictionary<int, TwType>
        {
            {32, TwType.Str32},
            {64, TwType.Str64},
            {128, TwType.Str128},
        ...
        /// </summary>
        /// <param name="type">Type code given by twain.
        ///     <para xml:lang="ru">Код типа данный twain.</para>
        /// </param>
        /// <returns>Managed type.
        ///     <para xml:lang="ru">Управляемый тип.</para>
        /// </returns>
        ...
        /// </summary>
        /// <param name="type">Managed type.
        ///     <para xml:lang="ru">Управляемый тип.</para>
        /// </param>
        /// <returns>Type code given by twain.
        ///     <para xml:lang="ru">Код типа данный twain.</para>
        /// </returns>
        internal static TwType TypeOf(Type type)
        {
            var _type = type.IsEnum ? Enum.GetUnderlyingType(type) : type;
            foreach (var _item in _typeof)
                if (_item.Value == _type)
                    return _item.Key;
            if (type == typeof(bool)) return TwType.Bool;
            if (type == typeof(float)) return TwType.Fix32;
            if (type == typeof(RectangleF)) return TwType.Frame;
        ...
        {
            if (obj is string) return _typeofAux[((string)obj).Length];
            return TypeOf(obj.GetType());
        }
        ...
        ///     <para xml:lang="ru">Размер в байтах.</para>
        /// </returns>
        internal static int SizeOf(TwType type)
        {
            return Marshal.SizeOf(_typeof[type]);
        }
        ...
        /// </summary>
        /// <param name="type">Twain type code.
        ///     <para xml:lang="ru">Код twain-типа.</para>
        /// </param>
        /// <param name="value">Instance of the object.
        ///     <para xml:lang="ru">Экземпляр объекта.</para>
        /// </param>
        ...
        internal static object CastToTw(TwType type, object value)
        {
            ...
            if (_type.IsEnum && Enum.GetUnderlyingType(_type) == TypeOf(type))
        ...
        internal static object ValueToTw<T>(TwType type, T value)
        {
            ...
            Twain32._Memory.ZeroMemory(mem, (IntPtr)size);
            try
            {
                Marshal.StructureToPtr(value, mem, true);
                return Marshal.PtrToStructure(mem, TypeOf(type));
            }
            finally
            {
        ...
        {
            var size = Math.Max(Marshal.SizeOf(typeof(T)), Marshal.SizeOf(value));
            var mem = Marshal.AllocHGlobal(size);
            Twain32._Memory.ZeroMemory(mem, (IntPtr)size);
            try
            {
...
#pragma warning disable CS1591 // Missing XML comment for public visible type or member / Отсутствует комментарий XML для открытого видимого типа или члена
        ...
        [TwType(TwType.Str32)] Halftones = 0x1109,
        ...
        [TwType(TwType.Str128)] Author = 0x1000,

        [TwType(TwType.Str255)] Caption = 0x1001,

        FeederEnabled = 0x1002,
        FeederLoaded = 0x1003,

        [TwType(TwType.Str32)] TimeDate = 0x1004,
        ...
        [TwType(TwType.Str32)] DeviceTimeDate = 0x101f, /* Added 1.8 */

        PowerSupply = 0x1020, /* Added 1.8 */
        CameraPreviewUI = 0x1021, /* Added 1.8 */
        DeviceEvent = 0x1022, /* Added 1.8 */

        [TwType(TwType.Str255)] SerialNumber = 0x1024, /* Added 1.8 */
        ...
        [TwType(TwType.Str255)] PrinterString = 0x102a, /* Added 1.8 */

        [TwType(TwType.Str255)] PrinterSuffix = 0x102b, /* Added 1.8 */
        ...
        [TwType(TwType.Str255)] CustomInterfaceGuid = 0x103c,
...
#pragma warning restore CS1591 // Missing XML comment for public visible type or member / Отсутствует комментарий XML для открытого видимого типа или члена
    ...
    ///     Compression values
    /// </summary>
    public enum TwCompression : ushort
    {
...
#pragma warning restore CS1591 // Missing XML comment for public visible type or member / Отсутствует комментарий XML для открытого видимого типа или члена
    ...
    internal struct TwFix32
    {
        ...
        ///     <para xml:lang="ru">Число с плавающей точкой.</para>
        /// </returns>
        ...
        ///     <para xml:lang="ru">Число с плавающей точкой.</para>
        /// </param>
        /// <returns>Instance of TwFix32.
        ///     <para xml:lang="ru">Экземпляр TwFix32.</para>
        /// </returns>
        ...
        ///     <para xml:lang="ru">Целое число.</para>
        /// </param>
        /// <returns>Instance of TwFix32.
        ///     <para xml:lang="ru">Экземпляр TwFix32.</para>
        /// </returns>
        ...
        ///     <para xml:lang="ru">Приводит тип к числу с плавающей запятой.</para>
        /// </summary>
        /// <param name="value">Instance of TwFix32.
        ///     <para xml:lang="ru">Экземпляр TwFix32.</para>
        /// </param>
        /// <returns>Floating point number.
        ///     <para xml:lang="ru">Число с плавающей точкой.</para>
        ...
        {
            return (ushort)value.Whole + ((uint)value.Frac << 16);
        }
    }
    ...
    internal class TwIdentity
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U4)] public TwDG SupportedGroups;
        ...
        {
            if (obj != null && obj is TwIdentity) return ((TwIdentity)obj).Id == Id;
            return false;
        }
    ...
    internal struct TwVersion
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwLanguage Language;

        /// <summary>
        ///     e.g. TWCY_SWITZERLAND
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwCountry Country;
    ...
    internal class TwUserInterface
    {
        ...
        /// </summary>
        public IntPtr ParentHand; // TW_USERINTERFACE
    ...
    internal class TwStatus
    {
        ...
        ///     Any TwCC constant
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwCC ConditionCode; // TwCC
    ...
    internal class TwEvent
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwMSG Message;
    }
    ...
    internal class TwImageInfo
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwCompression Compression;
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwPixelType PixelType;
        ...
        /// </summary>
        public short SamplesPerPixel; // TW_IMAGEINFO
    ...
    internal class TwInfo : IDisposable
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwEI InfoId;
        ...
        ///     Item data type.
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwType ItemType;
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwRC ReturnCode;

        /// <summary>
        ///     Returns true if the element value is an unmanaged memory descriptor; otherwise false.
        ///     <para xml:lang="ru">
        ///         Возвращает true, если значение элемента является дескриптором неуправляемой памяти; иначе,
        ///         false.
        ///     </para>
        /// </summary>
        private bool _IsValue => ItemType != TwType.Handle &&
                                 TwTypeHelper.SizeOf(ItemType) * NumItems <= TwTypeHelper.SizeOf(TwType.Handle);

        #region IDisposable

        public void Dispose()
        {
            if (Item != IntPtr.Zero && !_IsValue)
            {
                Twain32._Memory.Free(Item);
                Item = IntPtr.Zero;
            }
        }
        ...
        ///     <para xml:lang="ru">Значение элемента.</para>
        /// </returns>
        public object GetValue()
        {
            var result = new object[NumItems];
            if (_IsValue)
            {
                for (long i = 0,
                    data = Item.ToInt64(),
                    mask = (1L << (TwTypeHelper.SizeOf(ItemType) * 7) << TwTypeHelper.SizeOf(ItemType)) - 1;
                    i < NumItems;
                    i++, data >>= TwTypeHelper.SizeOf(ItemType) * 8)
                    result[i] = TwTypeHelper.CastToCommon(ItemType, TwTypeHelper.ValueToTw(ItemType, data & mask));
            }
            else
            {
                var data = Twain32._Memory.Lock(Item);
                try
                {
                    for (var i = 0; i < NumItems; i++)
                        if (ItemType != TwType.Handle)
                        {
                            result[i] = TwTypeHelper.CastToCommon(ItemType,
                                Marshal.PtrToStructure((IntPtr)((long)data + TwTypeHelper.SizeOf(ItemType) * i),
                                    TwTypeHelper.TypeOf(ItemType)));
                        }
                        else
                        {
                            result[i] = Marshal.PtrToStringAnsi(data);
                            data = (IntPtr)((long)data + result[i].ToString().Length + 1);
                        }
                }
                finally
                {
                    Twain32._Memory.Unlock(Item);
                }
            }
    ...
    /// <summary>
    ///     This structure is used to pass extended image information from the Data Source to the Application at the end of
    ///     State 7.
    /// </summary>
    [StructLayout(LayoutKind.Sequential, Pack = 2)]
    internal class TwExtImageInfo
    {
        ...
        /// </summary>
        /// <param name="info">A set of elements for an extended image description.
        ///     <para xml:lang="ru">Набор элементов расширенного описания изображения.</para>
        /// </param>
        /// <returns>Pointer to an unmanaged memory block.
        ...
        public static IntPtr ToPtr(TwInfo[] info)
        {
            ...
            var data = Marshal.AllocHGlobal(twExtImageInfoSize + twInfoSize * info.Length);
            Marshal.StructureToPtr(new TwExtImageInfo { NumInfos = (uint)info.Length }, data, true);
            for (var i = 0; i < info.Length; i++)
                Marshal.StructureToPtr(info[i], (IntPtr)(data.ToInt64() + twExtImageInfoSize + twInfoSize * i),
                    true);
            return data;
        }
    }
    ...
    internal class TwCapability : IDisposable
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwCap Cap;

        /// <summary>
        ///     TwOn.One, TwOn.Range, TwOn.Array or TwOn.Enum
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwOn ConType;
        ...
        public TwCapability(TwCap cap, string value, TwType type)
        {
            Cap = cap;
            ConType = TwOn.One;
            var twOneCustumValueSize = Marshal.SizeOf(typeof(TwOneCustumValue));
            Handle = Twain32._Memory.Alloc(twOneCustumValueSize + Marshal.SizeOf(TwTypeHelper.TypeOf(type)));
            var ptr = Twain32._Memory.Lock(Handle);
            try
            {
                Marshal.StructureToPtr(new TwOneCustumValue { ItemType = type }, ptr, true);
                Marshal.StructureToPtr(TwTypeHelper.CastToTw(type, value),
                    (IntPtr)(ptr.ToInt64() + twOneCustumValueSize), true);
            }
            finally
            {
        ...
        public TwCapability(TwCap cap, TwArray array, object[] arrayValue)
        {
            Cap = cap;
            ConType = TwOn.Array;
            var twArraySize = Marshal.SizeOf(typeof(TwArray));
            var twItemSize = Marshal.SizeOf(TwTypeHelper.TypeOf(array.ItemType));
            Handle = Twain32._Memory.Alloc(twArraySize + twItemSize * arrayValue.Length);
            var pTwArray = Twain32._Memory.Lock(Handle);
            try
            {
                Marshal.StructureToPtr(array, pTwArray, true);
                for (long i = 0, ptr = pTwArray.ToInt64() + twArraySize;
                    i < arrayValue.Length;
                    i++, ptr += twItemSize)
                    Marshal.StructureToPtr(TwTypeHelper.CastToTw(array.ItemType, arrayValue[i]), (IntPtr)ptr, true);
            }
            finally
            {
                Twain32._Memory.Unlock(Handle);
        ...
        public TwCapability(TwCap cap, TwEnumeration enumeration, object[] enumerationValue)
        {
            Cap = cap;
            ConType = TwOn.Enum;
            var twEnumerationSize = Marshal.SizeOf(typeof(TwEnumeration));
            var twItemSize = Marshal.SizeOf(TwTypeHelper.TypeOf(enumeration.ItemType));
            Handle = Twain32._Memory.Alloc(twEnumerationSize + twItemSize * enumerationValue.Length);
            var pTwEnumeration = Twain32._Memory.Lock(Handle);
            try
            {
                Marshal.StructureToPtr(enumeration, pTwEnumeration, true);
                for (long i = 0, ptr = pTwEnumeration.ToInt64() + twEnumerationSize;
                    i < enumerationValue.Length;
                    i++, ptr += twItemSize)
                    Marshal.StructureToPtr(TwTypeHelper.CastToTw(enumeration.ItemType, enumerationValue[i]),
                        (IntPtr)ptr, true);
            }
            finally
            {
        ...
        /// </summary>
        /// <returns>Instance TwArray, TwEnumeration, _TwRange or _TwOneValue.
        ///     <para xml:lang="ru">Экземпляр TwArray, TwEnumeration, _TwRange или _TwOneValue.</para>
        /// </returns>
        public object GetValue()
        {
            var ptr = Twain32._Memory.Lock(Handle);
            try
            {
                ...
                {
                    case TwOn.Array:
                        return new __TwArray((TwArray)Marshal.PtrToStructure(ptr, typeof(TwArray)),
                            (IntPtr)(ptr.ToInt64() + Marshal.SizeOf(typeof(TwArray))));
                    case TwOn.Enum:
                        return new __TwEnumeration((TwEnumeration)Marshal.PtrToStructure(ptr, typeof(TwEnumeration)),
                            (IntPtr)(ptr.ToInt64() + Marshal.SizeOf(typeof(TwEnumeration))));
                    case TwOn.Range:
                        return Marshal.PtrToStructure(ptr, typeof(TwRange));
                    case TwOn.One:
                        var value = Marshal.PtrToStructure(ptr, typeof(TwOneCustumValue)) as TwOneCustumValue;
                        switch (value?.ItemType)
                        {
                            ...
                            case TwType.Uni512:
                                return Marshal
                                    .PtrToStructure(
                                        (IntPtr)(ptr.ToInt64() + Marshal.SizeOf(typeof(TwOneCustumValue))),
                                        TwTypeHelper.TypeOf(value.ItemType)).ToString();
                            default:
        ...
        {
            Handle = Twain32._Memory.Alloc(Marshal.SizeOf(typeof(T)));
            var ptr = Twain32._Memory.Lock(Handle);
            try
            {
    ...
    internal class TwArray : ITwArray
    {
        ...
        [field: MarshalAs(UnmanagedType.U2)] public TwType ItemType { get; set; }
    ...
    {
        public uint Item; //TW_ONEVALUE. Container for one value.
    ...
    internal class TwRange
    {
        ...
        public uint
            DefaultValue; /* Power-up value.                        */ //TWON_RANGE. Container for a range of values.
    ...
    internal class TwImageMemXfer
    {
        ...
        {
            Compression = (TwCompression)ushort.MaxValue;
            BytesPerRow = BytesWritten = Columns = Rows = XOffset = YOffset = uint.MaxValue;
        }
    }
    ...
    internal class TwMemory
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U4)] public TwMF Flags;
    ...
    internal class TwSetupFileXfer
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwFF Format;
    ...
    internal class TwPalette8
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwPA PaletteType;
        ...
        {
            var result = new TwPalette8
            {
                PaletteType = palette.PaletteType,
                NumColors = (ushort)palette.Colors.Length,
                Colors = new TwElement8[256]
            };
            for (var i = 0; i < palette.Colors.Length; i++) result.Colors[i] = palette.Colors[i];
            return result;
        }
    }
    ...
    internal class TwDeviceEvent
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.U2)] public TwDE Event;
    ...
    {
        [MarshalAs(UnmanagedType.FunctionPtr)] public CallBackProc CallBackProc;
    ...
    internal delegate TwRC CallBackProc(TwIdentity srcId, TwIdentity appId, [MarshalAs(UnmanagedType.U4)] TwDG dg,
        [MarshalAs(UnmanagedType.U2)] TwDAT dat, [MarshalAs(UnmanagedType.U2)] TwMSG msg, IntPtr data);
    ...
    {
        private readonly ITwArray _data;

        internal __TwArray(ITwArray data, IntPtr items)
        {
            _data = data;
            Items = new object[_data.NumItems];
            for (long i = 0, offset = 0, _sizeof = TwTypeHelper.SizeOf(_data.ItemType);
                i < _data.NumItems;
                i++, offset += _sizeof)
                Items[i] = TwTypeHelper.CastToCommon(_data.ItemType,
                    Marshal.PtrToStructure((IntPtr)(items.ToInt64() + offset), TwTypeHelper.TypeOf(_data.ItemType)));
        }

        public TwType ItemType => _data.ItemType;

        public uint NumItems => _data.NumItems;
    ...
    {
        private readonly TwEnumeration _data;
        ...
        public int CurrentIndex => (int)_data.CurrentIndex;

        public int DefaultIndex => (int)_data.DefaultIndex;
    }
    ...
    internal class TwEntryPoint
    {
        ...
        /// </summary>
        [MarshalAs(UnmanagedType.FunctionPtr)] public DsmMemoryAllocate MemoryAllocate;

        /// <summary>
        ///     A pointer to the memory free function, taking the form void PASCAL DSM_MemAllocate (TW_HANDLE).
        /// </summary>
        [MarshalAs(UnmanagedType.FunctionPtr)] public DsmMemoryFree MemoryFree;

        /// <summary>
        ///     A pointer to the memory lock function, taking the form TW_MEMREF PASCAL DSM_MemAllocate (TW_HANDLE).
        /// </summary>
        [MarshalAs(UnmanagedType.FunctionPtr)] public DsmMemoryLock MemoryLock;

        /// <summary>
        ///     A pointer to the memory unlock function, taking the form void PASCAL DSM_MemUnlock (TW_HANDLE).
        /// </summary>
        [MarshalAs(UnmanagedType.FunctionPtr)] public DsmMemoryUnlock MemoryUnlock;
    ...
    internal delegate IntPtr DsmMemoryAllocate(int size);
